...
public class NServer {
	...
	public ExecutorService pool = new ThreadPoolExecutor(0, Integer.MAX_VALUE,
			60L, TimeUnit.SECONDS,
			new SynchronousQueue<>(), new ThreadFactoryBuilder().setNameFormat("%d-nio-selector").build());
